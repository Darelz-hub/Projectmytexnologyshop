"""
Django settings for texnologyshop project.
...
ROOT_URLCONF = 'texnologyshop.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / "texnologyshop/templates/"
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'texnologyshop.wsgi.application'
